...
class Renderer(object):
    ...
    def glTriangle_bc(self, A, B, C, verts = (), texCoords = (), normals = (), clr = None):
        ...
        edge1 = ml.subtract_twoVectorsOfSameSize(verts[1], verts[0])
        edge2 = ml.subtract_twoVectorsOfSameSize(verts[2], verts[0])

        triangleNormal = ml.cross_twoVectorsOfOneByThree( edge1, edge2)
        ...
        deltaUV1 = ml.subtract_twoVectorsOfSameSize(texCoords[1], texCoords[0])
        deltaUV2 = ml.subtract_twoVectorsOfSameSize(texCoords[2], texCoords[0])
        ...
        try:
            ...
            bitangent = ml.cross_twoVectorsOfOneByThree( triangleNormal, tangent)
            bitangent = ml.vectorDivideByNumber(bitangent, ml.norm(bitangent))
